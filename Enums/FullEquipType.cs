...
public static class FullEquipTypeExtensions
{
    ...
    internal static string OffhandTypeSuffix(this FullEquipType type)
        => type switch
        {
            FullEquipType.FistsOff   => "�����֣�",
            FullEquipType.DaggersOff => "�����֣�",
            FullEquipType.GunOff     => "����̫ת������",
            FullEquipType.OrreryOff  => "�����ף�",
            FullEquipType.RapierOff  => "�����֣�",
            FullEquipType.GlaivesOff => "�����֣�",
            FullEquipType.BowOff     => "��������",
            FullEquipType.KatanaOff  => "�����ʣ�",
            FullEquipType.TwinfangsOff => " (����)",
            FullEquipType.Palette    => "����ɫ�̣�",
            _                          => string.Empty,
        };

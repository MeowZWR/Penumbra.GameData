...
public static class Eqp
{
    ...
    public static string ToLocalName(this EqpEntry entry)
        => entry switch
        {
            ...
            EqpEntry.BodyUsesEvpTable         => "引用EVP表",
            ...
            EqpEntry.HeadShowEarringsHyurRoe        => "显示耳环（人族，鲁加族）",
            EqpEntry.HeadShowEarringsLalaElezen     => "显示耳环（精灵族，拉拉菲尔族）",
            EqpEntry.HeadShowEarringsMiqoHrothViera => "显示耳环（猫魅族，硌狮族，维埃拉族）",
            ...
            EqpEntry.HeadUsesEvpTable               => "使用EVP表",
